...
#else
    AXES[0] = new AxisEncoder(X_DCMOTOR,X_ENCODER_A,X_ENCODER_B,X_MIN_PIN,X_MAX_PIN,X_STEPS_PER_UNIT,X_INVERT_DIR,X_MAX_FEED,X_AVG_FEED,X_START_FEED,X_ACCEL_RATE,X_DISABLE);
#endif
#ifdef Y_STEP_PIN
...
#else
    AXES[1] = new AxisEncoder(Y_DCMOTOR,Y_ENCODER_A,Y_ENCODER_B,Y_MIN_PIN,Y_MAX_PIN,Y_STEPS_PER_UNIT,Y_INVERT_DIR,Y_MAX_FEED,Y_AVG_FEED,Y_START_FEED,Y_ACCEL_RATE,Y_DISABLE);
#endif
#ifdef Z_STEP_PIN
...
#else
    AXES[2] = new AxisEncoder(Z_DCMOTOR,Z_ENCODER_A,Z_ENCODER_B,Z_MIN_PIN,Z_MAX_PIN,Z_STEPS_PER_UNIT,Z_INVERT_DIR,Z_MAX_FEED,Z_AVG_FEED,Z_START_FEED,Z_ACCEL_RATE,Z_DISABLE);
#endif
#ifdef A_STEP_PIN
    AXES[3] = new AxisStepper(A_STEP_PIN,A_DIR_PIN,A_ENABLE_PIN,-1,-1,A_STEPS_PER_UNIT,A_INVERT_DIR,A_MAX_FEED,A_AVG_FEED,A_START_FEED,A_ACCEL_RATE,A_DISABLE);
#else
    AXES[3] = new AxisEncoder(A_DCMOTOR,A_ENCODER_A,A_ENCODER_B,-1,-1,A_STEPS_PER_UNIT,A_INVERT_DIR,A_MAX_FEED,A_AVG_FEED,A_START_FEED,A_ACCEL_RATE,A_DISABLE);
#endif
