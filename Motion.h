...
#else
    AXES[3] = new AxisEncoder(A_DCMOTOR,A_ENCODER_A,A_ENCODER_B,Pin(),Pin(),A_STEPS_PER_UNIT,A_INVERT_DIR,A_MAX_FEED,A_AVG_FEED,A_START_FEED,A_ACCEL_RATE,A_DISABLE);
#endif
