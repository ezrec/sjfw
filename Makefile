...
AFMOTOR_FILES = AFMotor/AFMotor.cpp
AFMOTOR_DEFINES = -IAFMotor

ENCODER_FILES = Encoder/Encoder.cpp
ENCODER_DEFINES = -IEncoder -DARDUINO=105


EXTRA_FILES = $(MOTION_FILES) $(LCD_FILES) $(SD_FILES) $(BOARD_FILES) $(KEYPAD_FILES) $(BT_FILES) $(LOOK_FILES) $(AFMOTOR_FILES) $(ENCODER_FILES)
EXTRA_DEFINES = $(MOTION_DEFINES) $(LCD_DEFINES) $(SD_DEFINES) $(BOARD_DEFINES) $(KEYPAD_DEFINES) $(BT_DEFINES) -DSJFW_VERSION='"$(SJFW_VERSION)"' $(LOOK_DEFINES) $(REVERSE_DEFINES) $(AFMOTOR_DEFINES) $(ENCODER_DEFINES)
